...
function EmptyBasket() {
  return (
    <div className={classes["empty_cart__centered-container"]}>
      <div className={classes.empty_cart__image}><img src={cartImage} alt="" /></div>
      ...
      <Link to={PagePaths.CATALOG} className={["link", classes.empty_cart__link].join(' ')}>В каталог товаров</Link>
    </div>
  );
}
